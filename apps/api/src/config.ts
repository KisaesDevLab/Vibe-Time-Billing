...
const Schema = z.object({
  ...
  // DS-3 — desktop shell auto-update. A directory on the appliance holding
  // `latest.json` (Tauri updater manifest) plus the signed installers it
  // references. Unset → /desktop/latest.json answers 404 and the shell's
