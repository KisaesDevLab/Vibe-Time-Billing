...
export function UserDetailPage(): JSX.Element {
  ...
  return (
    <div style={{ display: 'grid', gap: tokens.space.lg, maxWidth: 1000 }}>
      ...
      {tab === 'booking' && id && <BookingSettingsTab userId={id} />}
      {tab === 'notes' && (
        <NotesTab
          user={user}
          draft={draft}
...
// =====================================================================
// BK-1 — Booking Settings tab: weekly availability + buffers/notice/
// increment + the booking on/off switch. Reads/writes the per-staff
// booking endpoints (self-or-admin enforced server-side).
// =====================================================================
...
function BookingSettingsTab({ userId }: { userId: string }): JSX.Element {
