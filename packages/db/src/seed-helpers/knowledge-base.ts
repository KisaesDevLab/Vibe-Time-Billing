...
`),
  },
  {
    ...
    summary:
      'Auto-generate a bill for an engagement on a cadence (monthly, quarterly, etc.) with optional autopay.',
...
> A recurring billing **plan** generates *invoices* for an existing engagement. A [[recurring-engagements]] **recurrence** generates new *engagement periods*. They're different features and can be used together (a recurrence spawns the Jan engagement; a plan on it bills every month).
